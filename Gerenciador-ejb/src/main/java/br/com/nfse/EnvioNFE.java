...
public class EnvioNFE {
    ...
    public static ConfiguracoesNfe getConfiguracaoNFE() throws NfeException, CertificadoException {
    	List<Certificado> certificados = CertificadoService.listaCertificadosWindows();
    	Certificado certificado = null;
    	for(Certificado ce :certificados){
    		if(ce.getCnpjCpf().equalsIgnoreCase("03660921000179")){
    			certificado = ce;
    		}
    		
    	}
    		
    	return ConfiguracoesNfe.criarConfiguracoes(EstadosEnum.SC , AmbienteEnum.HOMOLOGACAO, certificado, "C:\\SRA\\Nfe\\Schemas");
    }
    ...
    private static Ide preencheIde(ConfiguracoesNfe config, String cnf, int numeroNfe, String tipoEmissao, String modelo, int serie, String cDv, LocalDateTime dataEmissao) throws NfeException {
        ...
        ide.setTpNF("1");
        ide.setIdDest("1");
        ide.setCMunFG("4211900"); //TODO AQUI VERIFICAR TB aqui palhoça acho que pode ser
        ide.setTpImp("1");
    ...
    private static Emit preencheEmitente(ConfiguracoesNfe config, String cnpj) {
        ...
        enderEmit.setCMun("4211900"); //COdigo palhoca
        ...
        emit.setIE("258149590"); //TODO VERIFICAR O QUE é coloquei arbitrario // IE da escola 256388326
        emit.setCRT("1");
    ...
    private static Prod preencheProduto() {
        ...
        prod.setCProd("CFOP9999");
        prod.setCEAN("00000000");
        prod.setXProd("Serviços de Transporte Escolar.");
        prod.setNCM("00");
        ...
        prod.setUCom("UN");
        prod.setQCom("1.0000");
        prod.setVUnCom("230.0000");
        prod.setVProd("230.00");
        //prod.setCEANTrib("7898480650104");
        prod.setUTrib("UN");
        prod.setQTrib("1.0000");
        prod.setVUnTrib("230.0000");
        prod.setIndTot("1");
    ...
    private static Imposto preencheImposto() {
        ...
        ICMS.ICMSSN102 icmssc102 = new ObjectFactory().createTNFeInfNFeDetImpostoICMSICMSSN102();      
        icmssc102.setCSOSN("103");
        icmssc102.setOrig("0");
        
        icms.setICMSSN102(icmssc102);
